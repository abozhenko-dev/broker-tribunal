...
export type OverviewCategoryDocument = OverviewCategory & mongoose.Document;
export const OverviewCategoryModel = SchemaFactory.createForClass(OverviewCategory);
